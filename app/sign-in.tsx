...
export default function SignInScreen() {
  ...
  const { authConfigured, isBusy, requestMagicLink, user } = useAuth();
        ...
        <ScrollView contentContainerStyle={styles.panel} showsVerticalScrollIndicator={false}>
          <ImageBackground source={require('../assets/images/nivium-hero-snow.png')} imageStyle={styles.heroImage} style={styles.hero}>
            ...
            <View style={styles.heroSubtitleStack}>
              <Text style={styles.heroSubtitle}>Sign In</Text>
              <Image source={require('../assets/images/nivium-hero-swish.png')} style={styles.heroSubtitleSwish} resizeMode="stretch" />
            </View>
          </ImageBackground>

          <ImageBackground source={require('../assets/images/nivium-mid-band.png')} imageStyle={styles.bandImage} style={styles.band}>
          ...
          <View style={styles.cardShell}>
            ...
            <View style={styles.card}>
              ...
              <Text style={styles.cardCopy}>We’ll send a one-time link that opens Nivium and signs you in.</Text>
...
const styles = StyleSheet.create({
  ...
  bandImage: { borderRadius: 8 },
  bandOverlay: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: 'rgba(9, 23, 38, 0.26)',
  },
  cardShell: {
    borderRadius: 8,
    padding: 3,
